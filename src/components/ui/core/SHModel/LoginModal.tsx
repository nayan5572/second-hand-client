    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="p-8 bg-white shadow-xl rounded-lg">
        ...
        <DialogDescription className="mt-2 text-lg text-gray-600">
          You need to be logged in to continue with this action. Please log in
          to access your account and proceed.
        </DialogDescription>
        <div className="mt-4">
          <p className="text-gray-500 text-md">
            If you already have an account, click Login Now to access your
            account.
          </p>
