...
const ContactForm = () => {
  ...
  const redirectFunction = (item: string) => {
    const facebook = "https://www.facebook.com/nayan.halder.756";
    const instagram = "";
    const twitter = "";
    let link = "";
            ...
            <SHForm onSubmit={onSubmit}>
              ...
              <div className="flex items-center pb-4 text-xs md:text-sm">
                ...
                <label htmlFor="privacy" className="text-gray-600">
                  I accept the <span className="text-[#149777]">privacy</span>{" "}
                  <span className="text-[#149777]">policy</span>
                </label>
              </div>
              <div className="w-full flex justify-center">
                <button
                  type="submit"
                  className="w-full md:w-1/3 flex justify-center items-center gap-3 bg-gradient-to-r text-white from-[#149777] to-[#149777] hover:from-[#10846F] hover:to-[#10846F] py-3 rounded-lg text-lg"
                >
