      ...
      <div className="mt-6 bg-[#f4f4f6] p-3 md:p-4 rounded-lg shadow-lg flex flex-col md:flex-row items-center gap-4 w-[100%] mx-auto md:w-full">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="text-white bg-gradient-to-r from-[#FFC800] to-[#FFC800] flex items-center justify-between gap-10 px-8 md:px-4 py-4 rounded-sm shadow-md"
          >
            <span className="block md:hidden">Search</span>{" "}
            <Search className="text-[#673500] font-medium" size={25} />
          </button>
        </div>
      </div>
    </div>
